...
class ControllerModuleParallax extends Controller {
	public function index($setting) {
		...
		$this->document->addScript('catalog/view/theme/default/js/parallax/cherry-fixed-parallax.js');
		$this->document->addScript('catalog/view/theme/default/js/parallax/device.min.js" type="text/javascript');
